<?php /* Smarty version 2.6.26, created on 2010-07-07 16:33:37
         compiled from lay_step2.html */ ?>
...
unset($_smarty_tpl_vars);
 ?>
<table border="0" cellpadding="0" cellspacing="0" class="tb_top">
  <tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="tb_body">
  <tr>
    <td class="tb_left"><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "module_left.html", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?></td>
    <td class="tb_cen"><div class="daohang"><?php echo $this->_tpl_vars['str_url']; ?>
</div><div class="bigdao"><?php echo $this->_tpl_vars['str_url_2']; ?>
</div>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "uio_step2.html", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?></td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="tb_bom">
  <tr>
    <td><?php $_smarty_tpl_vars = $this->_tpl_vars;
